...
class GatewayFlightService(IGatewayFlightService):
    ...
    def create_flight(self, data: FlightCreateDTO, created_by: int) -> GatewayResult[FlightDTO]:
        try:
    ...
    def get_flights_by_tab(self, tab: str, page: int, per_page: int, filters: dict[str, Any] | None = None) -> GatewayResult[PaginatedFlightsByTabDTO]:
        try:
    ...
    def get_flight(self, flight_id: int) -> GatewayResult[FlightDTO]:
        try:
    ...
    def update_flight(self, flight_id: int, data: FlightUpdateDTO, updated_by: int) -> GatewayResult[FlightDTO]:
        try:
    ...
    def update_flight_status(self, flight_id: int, data: FlightStatusUpdateDTO, admin_id: int) -> GatewayResult[FlightDTO]:
        try:
    ...
    def cancel_flight(self, flight_id: int, data: FlightCancelDTO, admin_id: int) -> GatewayResult[FlightDTO]:
        try:
    ...
    def delete_flight(self, flight_id: int, deleted_by: int) -> GatewayResult[None]:
        try:
    ...
    def get_available_seats(self, flight_id: int) -> GatewayResult[FlightAvailableSeatsDTO]:
        try:
    ...
    def get_flight_remaining_time(self, flight_id: int) -> GatewayResult[FlightRemainingTimeDTO]:
        try:
